...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT product_info.*, main_category.main_ctg_name 
            ...
            WHERE product_info.product_title LIKE '%$search%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 50px 0;">
